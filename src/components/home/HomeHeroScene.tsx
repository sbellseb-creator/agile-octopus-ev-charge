  ...
  return (
    <div className="relative min-h-[380px] overflow-hidden rounded-[30px] bg-slate-950">
      ...
      <img
        ...
        className="absolute bottom-[48px] left-[58%] z-20 w-[60%] max-w-[560px] -translate-x-1/2 object-contain drop-shadow-[0_22px_24px_rgba(0,0,0,.48)]"
      />

      {/* Dynamic Tesla charger state */}
      <div
        className={[
          "pointer-events-none absolute left-[22.8%] top-[44.5%] z-30 h-[18px] w-[4px] rounded-full transition-all duration-500",
          charging
            ? "bg-emerald-300 shadow-[0_0_8px_2px_rgba(52,211,153,.55)] animate-pulse"
            : pluggedIn
              ? "bg-blue-400 shadow-[0_0_7px_2px_rgba(96,165,250,.45)]"
              : "bg-white/90 shadow-[0_0_8px_2px_rgba(255,255,255,.35)]",
        ].join(" ")}
      />
      ...
      {(pluggedIn || charging) && (
        <div
          className={[
            ...
            charging
              ? "bg-emerald-300 shadow-[0_0_10px_4px_rgba(52,211,153,.6)] animate-pulse"
              : "bg-blue-400 shadow-[0_0_8px_3px_rgba(96,165,250,.45)]",
          ].join(" ")}
        />
      )}
